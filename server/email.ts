...
<body style="margin:0;padding:0;background:#0d0002;font-family:Georgia,serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0002;padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#1a0005;border-radius:20px;overflow:hidden;border:1px solid rgba(200,0,14,0.15);">
        <tr><td style="padding:36px 36px 0;">
          <p style="margin:0 0 4px;font-size:26px;color:#c8000e;font-weight:bold;letter-spacing:1px;">Gûstîlk</p>
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        <p style="margin:0 0 24px;font-size:14px;color:rgba(253,248,240,0.6);line-height:1.7;">
          ...
          This code expires in <strong style="color:#c8000e;">15 minutes</strong>.
        </p>
        <div style="margin:0 auto 28px;max-width:220px;text-align:center;padding:20px 28px;background:rgba(200,0,14,0.1);border-radius:16px;border:1.5px solid rgba(200,0,14,0.35);">
          <p style="margin:0;font-size:38px;font-weight:bold;letter-spacing:10px;color:#c8000e;font-family:monospace;">${code}</p>
        </div>
  ...
  await resend.emails.send({
    ...
    html: emailShell(`
      ...
      <p style="margin:0 0 28px;font-size:14px;color:rgba(253,248,240,0.6);line-height:1.7;">
        Click the button below to sign in instantly. This link expires in <strong style="color:#c8000e;">15 minutes</strong> and can only be used once — no password needed.
      </p>
      <table cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
        <tr><td style="border-radius:12px;background:linear-gradient(135deg,#c8000e,#e83535);">
          <a href="${magicLink}" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:bold;color:#1a0005;text-decoration:none;border-radius:12px;font-family:sans-serif;">
            Sign in to Gûstîlk
          </a>
        </td></tr>
      </table>
      <p style="margin:0 0 28px;font-size:12px;color:rgba(253,248,240,0.3);line-height:1.6;">
        ...
        <span style="color:rgba(200,0,14,0.6);word-break:break-all;">${magicLink}</span>
      </p>
    `),
  });
}
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
          <tr><td style="border-radius:12px;background:linear-gradient(135deg,#c8000e,#e83535);">
            <a href="https://www.gustilk.com" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:bold;color:#1a0005;text-decoration:none;border-radius:12px;font-family:sans-serif;">
              Open Gûstîlk
            </a>
          </td></tr>
        </table>
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        ${wasPremium ? `
        <div style="margin:0 0 24px;padding:16px;background:rgba(200,0,14,0.08);border-radius:12px;border:1px solid rgba(200,0,14,0.2);">
          <p style="margin:0 0 6px;font-size:12px;color:rgba(200,0,14,0.7);text-transform:uppercase;letter-spacing:1px;">Premium Subscription</p>
          <p style="margin:0;font-size:14px;color:rgba(253,248,240,0.7);line-height:1.6;">
            ...
            <a href="mailto:support@gustilk.com" style="color:#c8000e;">support@gustilk.com</a>.
          </p>
        </div>` : ""}
        ...
        <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
          <tr><td style="border-radius:12px;background:rgba(200,0,14,0.15);border:1px solid rgba(200,0,14,0.3);">
            <a href="mailto:support@gustilk.com" style="display:inline-block;padding:12px 28px;font-size:14px;font-weight:bold;color:#c8000e;text-decoration:none;border-radius:12px;font-family:sans-serif;">
              Contact Support
            </a>
          </td></tr>
        </table>
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        <p style="margin:0 0 20px;font-size:15px;color:#c8000e;font-weight:bold;">${userDisplayName}</p>
        ...
        <table cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
          <tr><td style="border-radius:12px;background:linear-gradient(135deg,#c8000e,#e83535);">
            <a href="https://www.gustilk.com/chat/${matchId}" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:bold;color:#1a0005;text-decoration:none;border-radius:12px;font-family:sans-serif;">
              Open Conversation
            </a>
          </td></tr>
        </table>
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        <p style="margin:0 0 6px;font-size:16px;color:#c8000e;font-weight:bold;">${applicantName}</p>
        ...
        <table cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
          <tr><td style="border-radius:12px;background:linear-gradient(135deg,#c8000e,#e83535);">
            <a href="${adminPanelUrl}" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:bold;color:#1a0005;text-decoration:none;border-radius:12px;font-family:sans-serif;">
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        ${reason ? `
        <div style="margin:0 0 20px;padding:16px;background:rgba(224,48,80,0.1);border-radius:12px;border:1px solid rgba(224,48,80,0.25);">
        ...
        <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
          <tr><td style="border-radius:12px;background:linear-gradient(135deg,#c8000e,#e83535);">
            <a href="https://www.gustilk.com/profile" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:bold;color:#1a0005;text-decoration:none;border-radius:12px;font-family:sans-serif;">
              Upload New Photo
            </a>
          </td></tr>
        </table>
