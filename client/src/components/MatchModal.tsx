...
const CONFETTI_COLORS = [
  "#FFD700", "#CC9900", "#A0000A", "#FFD700",
  "#10b981", "#FFFFFF", "#ff6b6b", "#4ecdc4", "#ffe066", "#a78bfa",
];
    ...
    <div className="relative flex-shrink-0" style={{ width: 88, height: 88 }}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 20px rgba(255,215,0,0.55), 0 0 40px rgba(255,215,0,0.25)",
        }}
      >
    ...
    >
      ...
      <style>{`
        @keyframes glow-pulse {
          0%   { box-shadow: 0 0 0 0 rgba(255,215,0,0.8), 0 0 12px rgba(255,215,0,0.5); }
          50%  { box-shadow: 0 0 0 10px rgba(255,215,0,0), 0 0 30px rgba(255,215,0,0.6); }
          100% { box-shadow: 0 0 0 0 rgba(255,215,0,0.0), 0 0 12px rgba(255,215,0,0.5); }
        }
      ...
      <div
        ...
        style={{
          background: "linear-gradient(160deg, #2d0f4a, #500004)",
          border: "1px solid rgba(255,215,0,0.35)",
          boxShadow: "0 0 60px rgba(123,63,160,0.5), 0 0 120px rgba(255,215,0,0.15)",
          zIndex: 2,
        }}
      >
        <button
          ...
          >
            <img
              ...
              style={{
                width: 48,
                height: 48,
                filter: "drop-shadow(0 0 10px rgba(255,215,0,0.9)) drop-shadow(0 0 24px rgba(255,215,0,0.5))",
              }}
            />
          </div>
        ...
        <h2 className="font-serif text-3xl font-bold text-gold mb-2" style={{ textShadow: "0 0 20px rgba(255,215,0,0.5)" }}>
          It's a Match!
        </h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            style={{ background: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.6)", border: "1px solid rgba(255,215,0,0.2)" }}
          >
            Keep Discovering
          </button>
        </div>
