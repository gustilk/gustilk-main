...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      style={{ background: "rgba(13,6,24,0.97)", backdropFilter: "blur(20px)", borderTop: "1px solid rgba(255,215,0,0.15)", paddingBottom: "env(safe-area-inset-bottom)" }}
    >
          ...
          >
            <div className="relative">
              ...
              {isActivity && likesCount > 0 && (
                <span
                  className="absolute -top-1 -right-1 w-4 h-4 rounded-full flex items-center justify-center text-[9px] font-bold"
                  style={{ background: "#FFD700", color: "#E30613" }}
