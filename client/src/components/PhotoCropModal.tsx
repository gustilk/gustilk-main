...
export function PhotoCropModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.92)" }}>
      <div className="w-full max-w-sm rounded-2xl overflow-hidden" style={{ background: "#1a0005", border: "1px solid rgba(200,0,14,0.35)" }}>
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none" style={{
            backgroundImage: "linear-gradient(rgba(200,0,14,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(200,0,14,0.1) 1px, transparent 1px)",
            backgroundSize: "33.33% 33.33%",
          }} />
          {/* Border */}
          <div className="absolute inset-0 pointer-events-none" style={{ boxShadow: "inset 0 0 0 2px rgba(200,0,14,0.5)" }} />
        </div>
