          ...
          <div className="px-5 -mt-4 relative z-10">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: "rgba(255,215,0,0.1)" }}>
                  <CalendarDays size={15} color="#FFD700" />
                </div>
                <div>
            ...
            <button
              ...
              style={event.isAttending
                ? { background: "rgba(255,215,0,0.12)", color: "#FFD700", border: "2px solid rgba(255,215,0,0.4)" }
                : { background: "linear-gradient(135deg, #A0000A, #FFD700)", color: "white", boxShadow: "0 8px 24px rgba(255,215,0,0.3)" }
              }
            >
