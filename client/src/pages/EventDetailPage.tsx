  ...
  return (
    <div className="flex flex-col min-h-screen pb-24" style={{ background: "#F9F9F9" }}>
      ...
      >
        ...
        >
          <ArrowLeft size={18} color="rgba(51,51,51,0.8)" />
        </button>
      </div>
          ...
          <div className="px-5 -mt-4 relative z-10">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: "rgba(244,196,48,0.1)" }}>
                  <CalendarDays size={15} color="#F4C430" />
                </div>
                <div>
            ...
            <button
              ...
              style={event.isAttending
                ? { background: "rgba(244,196,48,0.12)", color: "#F4C430", border: "2px solid rgba(244,196,48,0.4)" }
                : { background: "linear-gradient(135deg, #1E3A8A, #6BBF59)", color: "white", boxShadow: "0 8px 24px rgba(107,191,89,0.3)" }
              }
            >
