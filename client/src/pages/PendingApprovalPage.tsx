...
export default function PendingApprovalPage({ user }: Props) {
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12"
        ...
        <div className="w-full max-w-sm text-center">
          ...
          <button
            ...
            style={{ background: "rgba(0,0,0,0.05)", border: "1px solid rgba(0,0,0,0.08)", color: "rgba(51,51,51,0.5)" }}
          >
        ...
        <div className="w-full max-w-sm mx-auto">
          <div className="text-center mb-6">
            <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-5"
              style={{ background: "rgba(107,191,89,0.1)", border: "2px solid rgba(107,191,89,0.35)" }}>
              <XCircle className="w-10 h-10" color="#6BBF59" />
            </div>
          ...
          {reason ? (
            <div className="mb-5 p-4 rounded-2xl"
              ...
              <p className="text-xs font-bold uppercase tracking-wider mb-1.5" style={{ color: "#6BBF59" }}>Reason</p>
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl" style={{ background: "rgba(0,0,0,0.04)" }}>
              <Shield size={15} color="#6BBF59" className="flex-shrink-0 mt-0.5" />
          ...
          {reapplyStep === "idle" && (
            <div className="space-y-3 mb-4">
              <button
                ...
                style={{ background: "rgba(123,63,160,0.15)", border: "1px solid rgba(123,63,160,0.4)", color: "#F4C430" }}
              >
          ...
          {reapplyStep === "selfie" && (
            <div className="mb-4 p-4 rounded-2xl" style={{ background: "rgba(123,63,160,0.08)", border: "1px solid rgba(123,63,160,0.3)" }}>
              ...
              {selfieError && <p className="text-sm text-center mb-2" style={{ color: "#6BBF59" }}>{selfieError}</p>}
              <button
              ...
              <button onClick={() => setReapplyStep("idle")} className="w-full mt-2 py-2 text-xs text-center" style={{ color: "rgba(51,51,51,0.3)" }}>
                Cancel
              </button>
          ...
          {reapplyMutation.isError && (
            <p className="text-xs text-center mb-3" style={{ color: "#6BBF59" }}>
          ...
          <button
            ...
            data-testid="button-logout"
            className="w-full py-3 rounded-full text-sm font-semibold flex items-center justify-center gap-2"
            style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(51,51,51,0.4)" }}
          >
            <LogOut className="w-4 h-4" /> Sign Out
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12"
      ...
      <div className="w-full max-w-sm text-center">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6"
          style={{ background: "linear-gradient(135deg, #F4C43022, #1E3A8A22)", border: "2px solid #F4C43044" }}>
          <Clock className="w-10 h-10" style={{ color: "#F4C430" }} />
        </div>
        ...
        {appCount > 1 && (
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full mb-3 text-xs font-bold"
            style={{ background: "rgba(244,196,48,0.12)", border: "1px solid rgba(244,196,48,0.3)", color: "#F4C430" }}>
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: "rgba(0,0,0,0.05)" }}>
            <Shield className="w-5 h-5 flex-shrink-0" style={{ color: "#1E3A8A" }} />
        ...
        <button
          ...
          data-testid="button-logout"
          className="w-full py-3 rounded-full text-sm font-semibold flex items-center justify-center gap-2"
          style={{ background: "transparent", border: "1px solid rgba(0,0,0,0.09)", color: "rgba(51,51,51,0.45)" }}
        >
          <LogOut className="w-4 h-4" /> Sign Out
        </button>
      </div>
