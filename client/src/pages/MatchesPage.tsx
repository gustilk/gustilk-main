      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center h-48 gap-4 text-center px-8">
          <div className="w-16 h-16 rounded-full flex items-center justify-center"
            ...
            <MessageCircle size={28} color="rgba(255,215,0,0.5)" />
          </div>
        ...
        <div>
          ...
          {!isPremium && regularMatches.length > 0 && (
            <div className="mx-4 mb-4 mt-2 rounded-2xl p-4"
              style={{ background: "linear-gradient(135deg, rgba(255,215,0,0.1), rgba(123,63,160,0.1))", border: "1px solid rgba(255,215,0,0.3)" }}>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ background: "linear-gradient(135deg, #FFD700, #CC9900)" }}>
                  <Lock size={16} color="#500004" />
                </div>
    ...
    >
      <div className="relative">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #2d0f4a, #A0000A)",
            border: isPremium ? "2.5px solid rgba(255,215,0,0.5)" : "2.5px solid rgba(255,215,0,0.2)",
            boxShadow: isPremium ? "0 0 16px rgba(255,215,0,0.2)" : "none",
        ...
        {isPremium && getActiveLabel(other.activitySeenAt) && (
          <span className="absolute bottom-0.5 right-0.5 w-3.5 h-3.5 rounded-full border-2 bg-emerald-400"
            style={{ borderColor: "#E30613", boxShadow: "0 0 5px #34d399" }} />
        )}
      </div>
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #2d0f4a, #A0000A)",
            border: isPremium ? "2px solid rgba(255,215,0,0.5)" : "2px solid rgba(255,215,0,0.3)",
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2 mb-0.5">
          <div className="flex items-center gap-1.5 min-w-0">
            <span className="font-semibold text-sm truncate"
              style={{ color: isPremium ? "rgba(255,255,255,1)" : "rgba(255,255,255,0.25)" }}
        ...
        <div className="flex items-center gap-1.5">
          <Lock size={11} color="rgba(255,215,0,0.7)" />
          <p className="text-xs" style={{ color: isPremium ? "rgba(255,255,255,0.4)" : "rgba(255,215,0,0.7)" }}>
            {isPremium
              ? (lastMsg
