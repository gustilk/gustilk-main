...
export default function AdminLayout({ user }: { user: User }) {
  ...
  const sidebar = (
    <div className="flex flex-col h-full" style={{ background: "linear-gradient(180deg, #1a0b2e 0%, #E30613 100%)" }}>
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b" style={{ borderColor: "rgba(255,215,0,0.15)" }}>
        <div className="w-8 h-8 rounded-lg flex items-center justify-center font-serif text-sm font-bold text-gold"
          style={{ background: "linear-gradient(135deg, #A0000A, #FFD700)" }}>G</div>
        <div>
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-2">
        {NAV.map(group => (
          <div key={group.title} className="mb-4">
            <div className="text-[9px] font-bold uppercase tracking-widest px-3 py-1 mb-1" style={{ color: "rgba(255,215,0,0.4)" }}>
              {group.title}
            </div>
      ...
      {/* User info */}
      <div className="px-3 py-3 border-t" style={{ borderColor: "rgba(255,215,0,0.15)" }}>
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: "#E30613" }}>
      {/* Desktop sidebar */}
      <div className="hidden md:flex flex-col w-52 flex-shrink-0 border-r" style={{ borderColor: "rgba(255,215,0,0.15)" }}>
        {sidebar}
      </div>
      ...
      {sidebarOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          <div className="w-56 flex flex-col flex-shrink-0 border-r" style={{ borderColor: "rgba(255,215,0,0.15)" }}>
            {sidebar}
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Mobile top bar */}
        <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b" style={{ borderColor: "rgba(255,215,0,0.15)" }}>
