...
const EXPORTS = [
  ...
  { type: "matches", label: "Match Data", description: "All matches between users", icon: Heart, color: "#FFD700" },
...
export default function ExportPage({ user }: { user: User }) {
  ...
  return (
    <div className="p-4 md:p-6 max-w-2xl mx-auto">
      ...
      <div className="mt-6 p-4 rounded-2xl text-cream/40 text-xs" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.12)" }}>
