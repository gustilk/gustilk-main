            ...
            return (
              <div key={u.id} data-testid={`approval-card-${u.id}`}
                ...
                style={{
                  ...
                  border: isReapplication ? "1px solid rgba(251,191,36,0.4)" : "1px solid rgba(244,196,48,0.2)",
                }}>
                      ...
                      <div className="space-y-1.5 mt-2">
                        ...
                        {appHistory.map((h, i) => (
                          <div key={i} className="flex items-start gap-2 text-xs rounded-lg px-2.5 py-1.5"
                            style={{
                              background: h.action === "approved" ? "rgba(16,185,129,0.08)" : h.action === "banned" ? "rgba(239,68,68,0.08)" : "rgba(107,191,89,0.08)",
                              border: h.action === "approved" ? "1px solid rgba(16,185,129,0.2)" : h.action === "banned" ? "1px solid rgba(239,68,68,0.2)" : "1px solid rgba(107,191,89,0.2)",
                            }}>
                            <span className="font-bold flex-shrink-0 capitalize"
                              style={{ color: h.action === "approved" ? "#10b981" : h.action === "banned" ? "#ef4444" : "#6BBF59" }}>
                              {h.action}
                            </span>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-1">
                        ...
                        {u.gender && (
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold" style={{ background: "rgba(107,191,89,0.12)", color: "#6BBF59" }}>{u.gender}</span>
                        )}
                      </div>
                ...
                {profilePhotos.length > 0 && (
                  <div className="p-4 pb-0" style={{ borderBottom: "1px solid rgba(0,0,0,0.04)" }}>
