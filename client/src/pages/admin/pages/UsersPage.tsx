    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <div className="relative mb-3">
        ...
        <input value={search} onChange={e => handleSearch(e.target.value)}
          ...
          style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,215,0,0.15)" }} />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        {(["premium", "non_premium"] as const).map(val => (
          <button
            ...
            style={{
              background: filterPremium === val ? "rgba(255,215,0,0.2)" : "rgba(255,255,255,0.12)",
              border: filterPremium === val ? "1px solid rgba(255,215,0,0.55)" : "1px solid rgba(255,255,255,0.14)",
              color: filterPremium === val ? "#FFD700" : "rgba(255,255,255,0.45)",
            }}
          >
            <Crown size={11} />
        ...
        {([
          ...
          <button
            ...
            style={{
              background: filterCaste === val ? "rgba(123,63,160,0.2)" : "rgba(255,255,255,0.12)",
              border: filterCaste === val ? "1px solid rgba(123,63,160,0.55)" : "1px solid rgba(255,255,255,0.14)",
              color: filterCaste === val ? "#FFD700" : "rgba(255,255,255,0.45)",
            }}
          >
            {label}
          </button>
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr style={{ background: "rgba(255,255,255,0.10)", borderBottom: "1px solid rgba(255,215,0,0.1)" }}>
              ...
              <tbody>
                {users.map((u, idx) => (
                  <tr key={u.id} data-testid={`row-user-${u.id}`}
                    style={{ borderBottom: "1px solid rgba(255,255,255,0.10)", background: idx % 2 === 0 ? "transparent" : "rgba(255,255,255,0.01)" }}>
