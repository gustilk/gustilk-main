    ...
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center h-32 gap-2">
          <Heart size={32} color="rgba(255,215,0,0.3)" />
        ...
        <div className="space-y-3">
          {stories.map(story => (
            <div key={story.id} data-testid={`story-${story.id}`}
              ...
              style={{ background: "rgba(255,255,255,0.10)", border: "1px solid rgba(255,215,0,0.12)", opacity: story.visible ? 1 : 0.6 }}>
              <div className="flex items-start gap-3">
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                  <button onClick={() => toggleMutation.mutate({ id: story.id, visible: !story.visible })}
                    ...
                    style={{ background: "rgba(255,255,255,0.12)", color: story.visible ? "#10b981" : "#6b7280" }}>
