        ...
        <div className="space-y-3">
          {dupes.map((dupe, idx) => (
            <div key={idx} data-testid={`duplicate-pair-${idx}`}
              className="rounded-2xl p-4" style={{ background: "rgba(255,255,255,0.10)", border: "1px solid rgba(251,191,36,0.15)" }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[{ id: dupe.id1, email: dupe.email1, name: dupe.name1 }, { id: dupe.id2, email: dupe.email2, name: dupe.name2 }].map((u, i) => (
                  <div key={i} className="p-3 rounded-xl" style={{ background: "rgba(255,255,255,0.10)" }}>
