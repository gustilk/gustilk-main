...
export default function FeedbackPage({ user }: { user: User }) {
  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      ...
      <div className="rounded-2xl p-8 text-center" style={{ background: "rgba(0,0,0,0.04)", border: "1px dashed rgba(244,196,48,0.2)" }}>
        <MessageSquare size={32} color="rgba(244,196,48,0.4)" className="mx-auto mb-3" />
