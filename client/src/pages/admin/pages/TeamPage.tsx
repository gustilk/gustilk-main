...
export default function TeamPage({ user }: { user: User }) {
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      ...
      <div className="rounded-2xl p-4 mb-4" style={{ background: "rgba(0,0,0,0.04)", border: "1px solid rgba(244,196,48,0.15)" }}>
      ...
      <div className="rounded-2xl p-4" style={{ background: "rgba(0,0,0,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
        <div className="flex items-start gap-3">
          <Shield size={16} color="rgba(244,196,48,0.6)" className="mt-0.5 flex-shrink-0" />
          <div>
