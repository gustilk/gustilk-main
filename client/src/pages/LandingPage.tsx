...
import type { InputHTMLAttributes, SelectHTMLAttributes, ButtonHTMLAttributes, ReactNode, ChangeEvent } from "react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-ink relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm animate-slide-up">
        ...
        <div className="text-center mb-8">
          <div className="text-5xl mb-2" style={{ filter: "drop-shadow(0 0 18px rgba(201,168,76,0.5))" }}>
        ...
        <p className="text-center text-cream/30 text-xs mt-6">
          By continuing, you agree to our community guidelines based on Yezidi values.
        </p>
      </div>
    </div>
  );
