  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#E30613" }}>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-16 space-y-4 max-w-2xl w-full mx-auto">
        <div className="rounded-2xl p-4" style={{ background: "rgba(255,215,0,0.06)", border: "1px solid rgba(255,215,0,0.15)" }}>
        ...
        {Array.isArray(sections) && sections.map((s) => (
          <div key={s.num} className="rounded-2xl p-4" style={{ background: "rgba(255,255,255,0.10)", border: "1px solid rgba(255,215,0,0.1)" }}>
