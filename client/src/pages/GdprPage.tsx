  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F9F9F9" }}>
      <div className="flex items-center gap-3 px-5 pt-12 pb-4 flex-shrink-0"
        style={{ borderBottom: "1px solid rgba(244,196,48,0.12)" }}>
        <button
        ...
        <div className="flex items-center gap-2">
          <ShieldCheck size={18} color="#F4C430" />
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-16 space-y-4 max-w-2xl w-full mx-auto">
        <div className="rounded-2xl p-4" style={{ background: "rgba(244,196,48,0.06)", border: "1px solid rgba(244,196,48,0.15)" }}>
        ...
        {Array.isArray(sections) && sections.map((s) => (
          <div key={s.num} className="rounded-2xl p-4" style={{ background: "rgba(0,0,0,0.04)", border: "1px solid rgba(244,196,48,0.1)" }}>
        ...
        <p className="text-center text-xs pb-4" style={{ color: "rgba(51,51,51,0.2)" }}>
