...
export default function ActivityPage({ user }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col pb-24" style={{ background: "#0d2a1e" }}>
      {/* Header */}
            ...
            >
              ...
              {count > 0 && (
                <span
                  ...
                  style={{ background: isActive ? "#c9a84c" : "rgba(201,168,76,0.4)", color: isActive ? "#0d2a1e" : "rgba(253,248,240,0.8)" }}
