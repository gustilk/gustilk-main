...
export default function VerificationPage({ user }: Props) {
  ...
  if (step === "done") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center" style={{ background: "#E30613" }}>
  ...
  if (step === "checking") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-5" style={{ background: "#E30613" }}>
  ...
  if (step === "preview" && selfieData) {
    return (
      <div className="flex flex-col min-h-screen px-5" style={{ background: "#E30613" }}>
        ...
        <div className="flex-1 flex flex-col items-center gap-6">
          <div className="w-64 h-64 rounded-full overflow-hidden"
            style={{ border: "3px solid rgba(255,215,0,0.5)", boxShadow: "0 0 40px rgba(255,215,0,0.2)" }}>
          ...
          {submitError && (
            <div className="w-full rounded-2xl px-4 py-3 flex items-start gap-3"
              ...
              <AlertCircle size={18} className="flex-shrink-0 mt-0.5" color="#FFD700" />
              <p className="text-sm" style={{ color: "#FFD700" }}>{submitError}</p>
            </div>
          )}
  ...
  if (step === "camera") {
    return (
      <div className="flex flex-col min-h-screen" style={{ background: "#E30613" }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative px-5 gap-4">
          {!useFallback && (
            <div className="relative w-72 h-72">
              ...
              <div className="absolute inset-0 rounded-full pointer-events-none"
                style={{ border: "2px dashed rgba(255,215,0,0.4)" }} />
            </div>
          )}
          ...
          {cameraError && (
            <div className="w-full rounded-2xl px-4 py-3 flex items-start gap-3"
              style={{ background: "rgba(255,215,0,0.12)", border: "1px solid rgba(255,215,0,0.3)" }}>
              <AlertCircle size={18} className="flex-shrink-0 mt-0.5" color="#FFD700" />
              <p className="text-sm" style={{ color: "#FFD700" }}>{cameraError}</p>
            </div>
          )}
          ...
          {brightnessWarn && (
            <div className="w-full rounded-2xl px-4 py-3 flex items-start gap-3"
              ...
              <Sun size={18} className="flex-shrink-0 mt-0.5" color="#FFD700" />
