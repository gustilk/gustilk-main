...
export default function VerificationPage({ user }: Props) {
  ...
  if (step === "done") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center" style={{ background: "#060612" }}>
  ...
  if (step === "checking") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-5" style={{ background: "#060612" }}>
  ...
  if (step === "preview" && selfieData) {
    return (
      <div className="flex flex-col min-h-screen px-5" style={{ background: "#060612" }}>
