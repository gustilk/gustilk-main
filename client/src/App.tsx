...
function AdminSpinner() {
  return (
    <div className="flex items-center justify-center min-h-screen" style={{ background: "#060612" }}>
...
function AppShell({ user }: { user: User }) {
  ...
  return (
    <VideoCallContext.Provider value={callCtx}>
      <div className="flex flex-col min-h-screen" style={{ background: "#060612", fontFamily: "'Open Sans', sans-serif" }}>
        ...
        <main className="flex-1 overflow-hidden" style={{ background: "#060612" }}>
          {!isAdminRoute && (
            <Switch>
